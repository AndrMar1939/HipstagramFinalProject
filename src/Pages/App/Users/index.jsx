...
const UsersPage = () => {
    ...
    const firstContentDownload = useSelector((state)=> state.getUsersSlice.firstContentDownload);
    ...
    return (
        <div>
        {
            ...
            usersArr.map(user => <UsersGeneralCard user={user} key={user._id}></UsersGeneralCard> )
        }
    </div>
    )
}
